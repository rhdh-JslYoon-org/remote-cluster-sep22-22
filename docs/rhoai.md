...
2) Go to the `Data Science Projects` section and access your application's project named `remote-cluster-sep22-22`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `remote-cluster-sep22-22-notebook`.
...
5) In the terminal, run `cd remote-cluster-sep22-22` to navigate to your sample app's directory.
